  ...
  return (
    <div className='row p-0 m-0'>
      ...
      <div className='col-12'>
        <div className='row' style={{display:'flex', justifyContent:'space-between', alignItems:'center', alignContent:'center'}}>
        <div className='col-md-5 col-sm-12 m-lg-5 py-5'>
        ...
        <div className='col-md-4 col-sm-12 m-lg-5 py-5'>
          <div style={{border:'1px solid gray', width:'200px', height:'200px', boxShadow:'0px 3px 6px gray'}}> 
          </div>
        </div>
        </div>
      </div>
